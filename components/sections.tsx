...
import { instagramUrl, site, visual, whatsappUrl } from "@/site.config";
      ...
      <Container className="grid gap-12 lg:grid-cols-[1fr_1.5fr]">
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <Foto
            ...
            sizes="24rem"
            className="mt-10 hidden aspect-[4/5] w-full max-w-sm rounded-3xl rounded-bl-[96px] lg:block"
          />
        </div>
      ...
      <Container>
        <div className="grid overflow-hidden rounded-3xl rounded-bl-[72px] bg-marinho text-white lg:grid-cols-2 lg:rounded-bl-[160px]">
          ...
          <Foto
            ...
            className="h-56 bg-azul lg:h-auto lg:min-h-72"
          />
        </div>
      </Container>
    </section>
